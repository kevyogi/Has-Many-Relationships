...
--13
SELECT u.first_name AS post_author_first_name,
u.last_name AS post_author_last_name,
p.title AS post_title,
u1.username AS comment_author_username,
...
SELECT COUNT(c.id)
FROM posts p
JOIN comments c ON c.posts_id = p.id
WHERE p.created_at > '2015-7-14'::date;
